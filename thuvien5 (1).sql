...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 07, 2021 lúc 04:03 PM
...
INSERT INTO `phieutrasach` (`MaPhieuMuon`, `NgayTra`, `TongSoLuong`, `TrangThai`) VALUES
(26, '2022-01-04', 5, 'Đang Mượn');
...
(104, 'Lập trình java', 'Cung cấp các kiến thức cơ bản về ngôn ngữ lập trình Java, kiến thức về lập trình hướng đối tượng, xử lý biệt lệ, lập trình đa luồng, lập trình from với swing và kết nối cơ sở dữ liệu với Java…', 50, '2021-12-07', 'public/anhsach/242948983_1100881037325830_8989507541327078222_n.jpg', '100', 1, 8, 1, NULL),
...
(112, 'Phân tích hóa học thực phẩm', 'Phân tích hóa học thực phẩm là một môn học chuyên ngành giảng dạy cho sinh viên những năm cuối ngành công nghệ thực phẩm và liên quan. Môn học đòi hỏi người học đã có kiến thức cơ bản về Hóa học và các môn phân tích hóa học như phân tích định tính, phân tích định lượng, phân tích công cụ.', 100, '2021-12-07', 'public/anhsach/37.u5387.d20170720.t104534.802662.jpg', '60', 1, 7, 2, NULL),
...
(126, 'Công nghệ ô tô hệ thống phanh', 'Giáo trình được biên soạn bám sát chương trình khung của Tổng cục dạy nghề đã ban hành, cùng tham khảo nhiều chương trình quốc tế như City & Guilds, chương trình đào tạo của Nakanihon Automotive, tài liệu bảo dưỡng – sửa chữa của Ford, Toyota,…đáp ứng các yêu cầu ngày càng cao trong đào tạo và thực tế sản xuất.', 10, '2021-12-07', 'public/anhsach/243123372_400041901739903_8727708160448005195_n.png', '100', 1, 5, 3, NULL),
...
(4, 18004011, 'acb', 123485, 'Nam', 1, 3, '$2y$10$taMkKqKAkeEC5b4X4oLmaOCY2SGcMbDJ4ehSYCjauP3anjzZ2wQsW', 1);
